...
**Teorema 2**: A fim de que a função $f: X \rightarrow \mathbb{R}$ seja contínua no ponto $a$, é necessário e suficiente que, para toda sequência de pontos $x_n \in X$ com $\lim x_n = a$, tem-se que $\lim f(x_n) = f(a)$.
