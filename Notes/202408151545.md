...
**Definição**: (Ordenado em "corpo ordenado completo") Um corpo ordenado $X$ é denominado completo se qualquer subconjunto não-vazio, limitado superiormente, $Y \subset X$ possui supremo $sup(Y) = b \in X$.
