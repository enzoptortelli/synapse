...
**Definição**: (Matriz fundamental) A matriz $(I - Q)^{-1}R$ é denominada matriz fundamental. Ela nos dá a probabilidade a longo prazo de que a cadeia, começando no estado $i$, seja absorvida pelo estado $j$.
