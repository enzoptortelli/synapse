...
*Nota*: A matriz $(I - Q)^{-1}$  nos dá a probabilidade a longo prazo de que a cadeia, começando no estado $i$, seja absorvida pelo estado $j$.

**Definição**: (Matriz fundamental) A matriz $(I - Q)^{-1}$ é denominada matriz fundamental.
