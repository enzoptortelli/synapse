...
##### Distribuição Normal
Para calcular a esperança de uma normal qualquer, podemos calcular a esperança da normal padrão, que é fácil de ser calculada, depois utilizar o fato de que $E[X] = E[\mu + Z \sigma] = \mu$.
