...
**Definição**: Uma variável aleatória é uma função do espaço amostral para os números reais.

**Teorema**: Uma variável aleatória define um novo espaço amostral $\mathcal{X} = \{a \in \mathbb{R} | \exists s t.q. X(x) = a\}$.
