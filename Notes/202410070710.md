...
Esse exemplo nos mostra como a binomial negativa, assim como a Poisson,  pode ser usada para modelar fenômenos onde estamos esperando por uma ocorrência. No caso da binomial negativa, estamos esperando por um número de sucessos específicado.
