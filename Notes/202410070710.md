...
Assim, tomemos a função gama e o intervalo $(0, \infty)$.  Ela é definida por $\Gamma(\alpha) = \int_0^\infty t^{\alpha - 1} e^{-t}dt$ para $\alpha > 0$. Provamos que ela é finita para todo
[[202410220703.excalidraw]]
