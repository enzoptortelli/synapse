...
##### Distribuição Cauchy
A distribuição Cauchy é simétrica, com formato de sino e suporte na reta real. Sua $fdp$ é dada por: $$f(x|\theta) = \frac{1}{\pi} \frac{|x|}{1 + (x - \theta)^2} \mathbb{1}_{(-\infty, \infty)}(x) \quad \forall -\infty < \theta < \infty.$$

![[202410280720.excalidraw]]
