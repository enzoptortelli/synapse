...
**Teorema**: (Desigualdade de Chebychev) Seja $X$ uma variável aleatória $g(x)$ uma função não negativa. Assim, para $r > 0$, $$P(g(X) \geq r) \leq \frac{E[g(X)]}{r}$$
...
Exerc interessantes 2.27, 3.27. 3.39, 3.40, 3.46, 3.48
