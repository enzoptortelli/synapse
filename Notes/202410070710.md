...
A distribuição binomial pode ser aproximada pela distribuição normal (para provar, podemos usar o TCL junto com o fato de que a binomial é uma soma de Bernoulli's [[202410260637.excalidraw]]).  Uma boa regra para que a aproximação seja boa é que $\min \{np, n(1-p)\} \geq 5$. A correção de continuidade se justifica com porque a
